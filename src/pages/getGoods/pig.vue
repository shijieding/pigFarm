      ...
      <div class="form">
        <div class="table">
          <ul class="list" v-show="getType">
            <li class="title">
              <div class="left w25">名称</div>
              <div class="left w25">来源</div>
              <div class="left w25">单价(元)</div>
              <div class="left w25">库存</div>
            </li>
            <li v-for="p in pList">
              <div class="left w25"><div class="c_box"><input type="checkbox" class="checkbox" v-model="p.isChose"/>{{p.name}}</div></div>
              <div class="left w25">{{p.from}}</div>
              <div class="left w25">{{p.price}}</div>
              <div class="left w25">{{p.quantity}}</div>
            </li>
          </ul>
          <ul class="list" v-show="getNumber">
            <li class="title">
              <div class="left w20">名称</div>
              <div class="left w20">来源</div>
              <div class="left w20">单价(元)</div>
              <div class="left w20">库存</div>
              <div class="left w20">数量</div>
            </li>
            <li v-for="c in choseList">
              <div class="left w20">{{c.name}}</div>
              <div class="left w20">{{c.from}}</div>
              <div class="left w20">{{c.price}}</div>
              <div class="left w20">{{c.quantity}}</div>
              <div class="left w20"><input type="number" v-model="c.num" class="w50" style="width:50%;transform: translatey(-2px)"/></div>
            </li>
          </ul>
        </div>
        <div class="btn_box">
